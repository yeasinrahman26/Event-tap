  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen bg-gray-50">
      ...
      <main className="flex-1 p-4 md:p-8 bg-[#FAF4F1]">
        <div className="max-w-3xl mx-auto bg-white rounded-lg shadow p-4 md:p-6">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-4">
              ...
              <Link href="/eventCreate">
                <button className="px-6 py-2 border-2 border-[#E60076] text-[#E60076] rounded transition hover:shadow-md hover:scale-105">
                  Create Event
                </button>
              </Link>
            </div>
